...
proc create_root_design { parentCell } {
  ...
  set US_Trigger [ create_bd_port -dir O US_Trigger ]
  ...
  connect_bd_net -net axi_timer_1_pwm0 [get_bd_ports US_Trigger] [get_bd_pins axi_timer_1/pwm0]
  connect_bd_net -net capturetrig0_0_1 [get_bd_ports US_Echo] [get_bd_pins axi_timer_0/capturetrig0] [get_bd_pins axi_timer_0/capturetrig1]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
