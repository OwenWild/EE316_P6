...
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports capturetrig0_0]
#set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports capturetrig1_0]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports pwm0_0]
